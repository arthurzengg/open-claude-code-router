...
// Make the rewritten request valid for the target tier. Mutates body.
function sanitizeBody(body, label, limits = MODEL_LIMITS) {
  if (label === 'simple') {
    ...
    // effort "xhigh" is Opus-only; "max" is the closest Sonnet-valid level.
